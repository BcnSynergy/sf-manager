...
describe('Review Sessions (e2e)', () => {
  ...
  describe('Malformed :sessionId rejection (tech-debt cleanup)', () => {
    ...
    // MAINTENANCE_TECHNICIAN, COMMUNITY_REPRESENTATIVE) unconditionally —
    // there is no role that could reach this route and be refused by
    // PermissionsGuard, so a 403 case is unreachable here. If a future
    // role is added without this permission, add the case then.
  });
